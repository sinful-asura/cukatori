/**
 * MuscleWiki-backed exercise library. Distinct from `./types`, which models the lifts
 * workouts are logged against. Keep in sync with `api/src/contracts/exercise-library.ts`.
 */
